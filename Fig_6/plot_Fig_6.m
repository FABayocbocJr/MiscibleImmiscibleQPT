...
%%% detun 109.37 ; tQ = 0.00400 ; task = 75 %%%
...
legend('$t=32.29~\mathrm{ms}$','$t=60.54~\mathrm{ms}$','Interpreter','latex','location','best','fontsize',fs-2)

print('Fig_6b.eps','-depsc')
